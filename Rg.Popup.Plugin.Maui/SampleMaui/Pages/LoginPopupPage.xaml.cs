...
namespace Demo.Pages
{
    public partial class LoginPopupPage : PopupPage
    {
        ...
        private async void OnLogin(object sender, EventArgs e)
        {
            ...
            await Rg.Plugins.Popup.Services.PopupNavigation.Instance.PushAsync(loadingPage);
            await Task.Delay(2000);
            await Rg.Plugins.Popup.Services.PopupNavigation.Instance.RemovePageAsync(loadingPage);
            await Rg.Plugins.Popup.Services.PopupNavigation.Instance.PushAsync(new LoginSuccessPopupPage());
        }
